...
/*
 	...
 	즉, 외부 정렬 기준을 구현할 때 사용하는 인터페이스이다.
 	
 	Comparable에서는 compareTo()메서드를 재정의 해야하고,
 	Comparator에서는 compare()메서드를 재정의 해야한다
 	
 	String클래스, Wrapper클래스, Data클래스, File클래스 등에는 이미 내부 정렬 기준이 구현되어 있다.
 */

public class ListSortTest {

	public static void main(String[] args) {
		//정렬 : 크기 순으로 데이터를 나열하는 것 (오름차순/내림차순)
		//선택, 삽입, 버블 정렬 알고리즘 => 더 발전하고 다양한 알고리즘 등장
		...
		// Collections.sort()메서드는 정렬한 데이터의 '내부 정렬 기준'을 바탕으로 정렬한다
