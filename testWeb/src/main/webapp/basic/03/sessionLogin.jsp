...
<body>
 <%
 	...
 	MemberVO loginMemverVO = (MemberVO) session.getAttribute("loginMember");
 %>
<%
	if(loginMemverVO == null){	// 로그인 관련 세션이 없을 때
%>
	<form action="<%=request.getContextPath()%>/sessionLogin.do" method="post">
		<table border="1" style="margin : 0 auto;">
		  ...
		  <tr>	
			<td>PASS : </td>
			<td><input name='mempass' type="password" placeholder='PassWord를 입력하세요'></td>
		  </tr>
...
<div style="text-align:center;">
	<h3><%=loginMemverVO.getMem_id() %>님 반갑습니다.</h3>
