...
public class ThreadTest02 {
	...
	public static void main(String[] args) {
		...
		//      그리고 Thread객체를 생성할 때 Thread의 생성자에 Runnable인터페이스를 구현할 클래스의 인스턴스 값을
		//      넣어서 실행한 후 이 Thread객체의 start()메서드를 호출해서 실행한다.
		
		MyRunner r1 = new MyRunner();  // 구현class의 인스턴스 생성
		
		// Thread클래스를 생성할 때 생성자에 구현한class의 인스턴스를 넣어서 생성한다
